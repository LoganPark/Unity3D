...
private var hotbarItemStrings : String[] = ["Magenta", "Red", "Yellow", "Green", "Cyan", "Blue", "White", "Gray", "Black"];
...
function assignPrimMatter(prim : GameObject) {
	 if( hotbarItemStrings[hotbarIndex] == "Magenta" ) {
		prim.renderer.material.color = Color.magenta;
	} else if( hotbarItemStrings[hotbarIndex] == "Red" ) {
		prim.renderer.material.color = Color.red;
	} else if( hotbarItemStrings[hotbarIndex] == "White" ) {
		prim.renderer.material.color = Color.white;
	} else if( hotbarItemStrings[hotbarIndex] == "Yellow" ) {
		prim.renderer.material.color = Color.yellow;
	} else if( hotbarItemStrings[hotbarIndex] == "Green" ) {
